...
_Generated: 2026-07-23T06:10:09.160Z_
...
Workspace `mcp.json` _(folder: cinematch-fullstack)_

- **c:\Users\PC_1\OneDrive\Desktop\Desktop\cinematch-fullstack\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\PC_1\.claude.json** — _File exists — no servers defined_
